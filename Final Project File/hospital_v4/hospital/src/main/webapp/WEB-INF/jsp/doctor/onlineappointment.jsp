    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bgm" >
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul
                ...
                <!--<li class="njghhryr  dssav-item" role="presentation"><a class="nav-link active" href="waitinglist"><i class="fas fa-tachometer-alt" style="color: rgba(197,1,1,0.74);"></i><span style="color: rgb(0,21,211);">Dashboard</span></a></li>-->
