    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bgm" >
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul
                ...
                <li class="nav-item" role="presentation"><a class="nav-link" href="/staff/appointmentform"><i class="fas fa-clinic-medical" style="color: rgba(197,1,1,0.74);"></i><span style="color: #0e20c2;"><strong>Waiting List</strong><br></span></a></li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container my-4">
                    <p class="font-weight-bold">Staff Home Page</p>
                    <div class="row">
                        <!-- Grid column -->
