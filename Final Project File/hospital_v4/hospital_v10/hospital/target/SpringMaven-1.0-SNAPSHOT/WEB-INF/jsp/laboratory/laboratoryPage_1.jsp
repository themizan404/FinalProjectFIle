                ...
                <form>
                    <div class="form-row profile-row">
                        <div class="col-md-8 col-lg-8 offset-lg-2">
                            <h1 style="color: rgb(22,135,254);background-color: rgba(247,247,247,0);"><strong>Laboratory&nbsp;Profile</strong></h1>
                            <hr>
                            <div class="form-group"><label style="font-size: 16px;"><strong>Laboratory&nbsp;ID</strong></label><input class="form-control" type="number"></div>
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group"><label style="font-size: 16px;"><strong>Laboratory&nbsp;Name</strong></label><input class="form-control" type="text" name="firstname"></div>
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
        ...
        <div id="update" class="tab-pane fade">
            <div class="container shadow-lg profile profile-view" id="profile" style="background-color: #f4f4f4;margin-top: 0px;margin-bottom: 150px;">
                ...
                <form>
                    <div class="form-row profile-row">
                        <div class="col-md-8 col-lg-8 offset-lg-2">
                            <h1 style="color: rgb(22,135,254);background-color: rgba(247,247,247,0);"><strong>Update Laboratory&nbsp;Profile</strong></h1>
                            <hr>
                            <div class="form-group"><label style="font-size: 16px;"><strong>Laboratory&nbsp;ID</strong></label><input class="form-control" type="number"></div>
                            <div class="form-row">
                                <div class="col">
